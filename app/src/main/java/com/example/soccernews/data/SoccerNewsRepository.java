...
public class SoccerNewsRepository {
    ...
    //region Constantes
    private static final String REMOTE_API_URL = "https://charbinho86.github.io/Soccer_News_API/";
    ...
    //region Singleton: Garante uma instancia única dos atributos relacionados ao Retrofit e Room.
